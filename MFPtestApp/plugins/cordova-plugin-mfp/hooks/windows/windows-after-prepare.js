...
function WindowsAfterPrepare(projectDirectory) {
    ...
    */
    ...
    function modifyWorklightJS() {
        ...
        that.deleteFile(hookConsts.WORKLIGHT_PATH_WINDOWS);
        ...
        that.copyFile(path.join(projDir,
            ...
            hookConsts.PREVIEW_IBMMFPF_PATH_WINDOWS));
    }
    ...
    function modifyBootstrapJS() {
        ...
        that.copyFile(path.join(projDir,
            ...
            hookConsts.BOOTSTRAP_PATH_WINDOWS));
    }
    ...
    function addNodeModules() {
        ...
        modules.forEach(function(module) {
            that.copyDir(path.join(projDir, hookConsts.MFP_PLUGIN_DIR, module),
                path.join(projDir, hookConsts.WORKLIGHT_DIR_WINDOWS, 'node_modules'));
        });
    }
