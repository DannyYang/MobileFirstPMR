...
function IOSAfterPrepare(projectDirectory) {
    ...
    function modifyWorklightJS() {
        ...
        that.deleteFile(hookConsts.WORKLIGHT_PATH_IOS);
        ...
        that.copyFile(path.join(projDir,
            ...
            hookConsts.PREVIEW_IBMMFPF_PATH_IOS));
    }
    ...
    function addNodeModules() {
        ...
        modules.forEach(function(module) {
            that.copyDir(path.join(projDir, hookConsts.MFP_PLUGIN_DIR, module),
                path.join(projDir, hookConsts.WORKLIGHT_DIR_IOS, 'node_modules'));
        });
    }
